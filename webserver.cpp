...
WebServer::WebServer()
{
    ...
    //将当前工作目录的绝对路径复制到参数server_path所指的内存空间
...
void WebServer::timer(int connfd, struct sockaddr_in client_address)
{
    ...
    heap_timer *timer = new heap_timer(2*TIMESLOT);
...
{
    time_t timeout = time(NULL) + 2 * TIMESLOT;
    utils.m_time_heap->adjust_timer(timer, timeout);
